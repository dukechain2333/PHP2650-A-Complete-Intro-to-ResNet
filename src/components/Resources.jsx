...
const resources = [
    {
        href: 'https://github.com/dukechain2333',
        name: 'William Qian',
        description:
            'William Qian is a master student at the Brown University School of Public Health. He is currently studying Biostatistics, and he used to be a Data Science student.',
        icon: UserIcon,
        pattern: {
            y: 16,
            squares: [
    ...
    {
        href: 'https://github.com/dz6190918',
        name: 'Dingxuan Zhang',
        description:
            'Dingxuan Zhang refused to say anything about himself.',
        icon: UserIcon,
        pattern: {
            y: 16,
            squares: [
